...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/", "/students/save", "/students/showAddForm", "/students/403")
				.hasAnyAuthority("USER", "ADMIN").antMatchers("/students/updateStudentForm", "/students/delete")
